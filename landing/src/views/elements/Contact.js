        ...
        <div className="max-w-2xl mx-auto">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
              <Input
                placeholder={name}
                className="border-[2px] border-black dark:border-white bg-lightTheme-primary bg-darkTheme-primary placeholder-black dark:placeholder-gray-700 text-lightTheme-text"
                name="user"
                value={formData.user}
